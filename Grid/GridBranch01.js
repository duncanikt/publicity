  ...
  const token = localStorage.getItem('jwt');
    ...
    var url = 'https://duncanikt.ddns.net/data?search=' + encodeURIComponent(searchInput) +  '&engName=' + encodeURIComponent(engName) + '&startDate=' + encodeURIComponent(startDate) + '&endDate=' + encodeURIComponent(endDate);
    addBT = '' ;
    fetch(url, {
      method: 'GET',
      headers: {
  ...
  function toggleButton(button) {
    ...
    } else 
    {
      ...
      selectButtons.forEach(function(button) {
        ...
        // 發送修改請求，保存資料
        var url = 'https://duncanikt.ddns.net/update';
        fetch(url, {
          method: 'POST',
          headers: {
  ...
  function getMaxValueFromDatabase() 
    {
        ...
        var url = 'https://duncanikt.ddns.net/maxValue';
        fetch(url)
          .then(function(response) {
            return response.json();
          })
  ...
  function saveRecord() 
    {
      ...
      fetch('https://duncanikt.ddns.net/insert', { // 替換為後端 MongoDB 的 URL
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
  ...
  function deleteRecord(button) {
    return new Promise((resolve, reject) => {
      ...
      // 發送刪除請求
      var url = 'https://duncanikt.ddns.net/delete';
